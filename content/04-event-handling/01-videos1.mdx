...
<YoutubeEmbed link="https://www.youtube.com/embed/videoseries?list=PLc6AmvC5ZybyAnzHb-wMic51nUNZpBZkQ" />

Make sure to watch the entire playlist! You can also access it directly on Youtube: https://www.youtube.com/watch?v=tRI70opACro&list=PLc6AmvC5ZybyAnzHb-wMic51nUNZpBZkQ

# Code

The starter code and completed code for this lecture can be accessed here: https://github.com/ihollander/js-lectures-event-handling
