---
title: "Lesson Videos: API Setup"
publish: true
---

# Video Playlist

<YoutubeEmbed link="https://www.youtube.com/embed/videoseries?list=PLc6AmvC5Zyby14ZyA2P3jmjwwRbSvnOoW " />

Make sure to watch the entire playlist! You can also access it directly on Youtube: https://www.youtube.com/watch?v=zdcFwInEZjc&list=PLc6AmvC5Zyby14ZyA2P3jmjwwRbSvnOoW

# Code

The starter code and completed code for this lecture can be accessed here: https://github.com/ihollander/js-lectures-rails-as-an-api
